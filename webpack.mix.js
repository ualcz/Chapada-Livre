...
mix.sass(`${sassBaseDir}/auth/fonts.scss`, `${tmpCssBaseDir}/auth/fonts.css`);
...
mix.sass(`${sassBaseDir}/front/fonts.scss`, `${tmpCssBaseDir}/front/fonts.css`);
...
mix.sass(`${sassBaseDir}/admin/fonts.scss`, `${tmpCssBaseDir}/admin/fonts.css`);
