...
use App\Models\Post\ReviewsAddon;
...
class Post extends BaseModel implements Feedable
{
	...
	*/
	...
	protected function priceLabel(): Attribute
	{
		return Attribute::make(
			get: function () {
				$defaultLabel = trans('global.price') . ':';
				...
				$result = match (true) {
					$isJob => trans('global.Salary') . ':',
					$isRent => trans('global.Rent') . ':',
					$isNotSalable => null,
	...
	protected function priceFormatted(): Attribute
	{
		return Attribute::make(
			get: function () {
				$defaultValue = trans('global.Contact us');
	...
	private function priceFormattedWithCategory(?string $defaultValue): string
	{
		...
		$result = match (true) {
			...
			default => match (true) {
				...
				$isFree => trans('global.free_as_price'),
