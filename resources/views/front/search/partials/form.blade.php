@php
	...
	if (!empty($city)) {
		...
		if (!empty($qAdminName)) {
			...
			$qLocation = !$isAdminCode ? trans('global.area') . rawurldecode($qAdminName) : null;
		}
	}
			...
			<div class="col-12 px-1 py-1 bg-primary rounded">
				<div class="row gx-1 gy-1">
					...
					@php
						$firstOption = [
							'value' => '',
							'text'  => trans('global.all_categories'),
						];
					...
					@include('helpers.forms.fields.select2', [
						...
						'name'        => 'c',
						'required'    => true,
						// 'placeholder' => trans('global.all_categories'),
						'options'     => $catOptions,
						'value'       => $qCategory,
						'hint'        => null,
						'baseClass'   => [
