...
@php
	...
	$errorMessage = trans('global.no_packages_found');
...
@section('content')
	...
	<div class="main-container">
		<div class="container" id="pricing">
			...
			@include('helpers.titles.title-2', ['title' => trans('global.Pricing')])
					...
					<ul class="nav nav-pills justify-content-center mb-3" id="pills-tab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link {{ $promoLinkClass }}"
							        ...
							        aria-selected="false"
							>{{ trans('global.promo_packages_tab') }}</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link {{ $subsLinkClass }}"
							        ...
							        aria-selected="true"
							>{{ trans('global.subs_packages_tab') }}</button>
						</li>
					</ul>
				@endif
